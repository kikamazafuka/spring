...
import de.artsem.springcourse.util.PersonValidator;
...
public class PeopleController {
    ...
    @Autowired
    public PeopleController(PeopleService peopleService, ItemService itemService, PersonDAO personDAO, BooksService booksService, PersonValidator personValidator) {
